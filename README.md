...
### Prøv selv
I tilknytning til den gamle Virtuoso-løsningen vå, lagde vi en samlig [sparql-apørringer](http://grepwiki.udir.no/index.php?title=SPARQL-spørringer) som kjøres mot http://data.udir.no/kl06/sparql.
I forbindelse til dette prosjektet, har vi prøvd å konvertere disse spørringene til noe som fungerer mot det nye endepunktet. Se:
